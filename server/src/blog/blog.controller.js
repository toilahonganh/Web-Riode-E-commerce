...
var BlogController = function () {
    var _classDecorators = [(0, common_1.Controller)('blog')];
    ...
    var BlogController = _classThis = /** @class */ (function () {
        ...
        BlogController_1.prototype.createBlog = function (createBlogDto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.blogService.createBlog(createBlogDto)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        };
        BlogController_1.prototype.getBlogs = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        BlogController_1.prototype.getAllBlogs = function () {
            return __awaiter(this, void 0, void 0, function () {
                var _a, blogs, totalBlogs, error_1;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _b.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, this.blogService.findAllBlogs()];
                        case 1:
                            _a = _b.sent(), blogs = _a.blogs, totalBlogs = _a.totalBlogs;
                            return [2 /*return*/, {
                                    blogs: blogs,
                        ...
                        case 2:
                            error_1 = _b.sent();
                            throw new common_1.HttpException('Error fetching blogs', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
                        case 3: return [2 /*return*/];
                    }
                });
            });
        };
        BlogController_1.prototype.editUser = function (id, updateData) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.blogService.editBlog(id, updateData)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        };
        BlogController_1.prototype.deleteProduct = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.blogService.deleteBlog(id)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    (function () {
        ...
        _getBlogs_decorators = [(0, common_1.Get)('get-blogs')];
        _getAllBlogs_decorators = [(0, common_1.Get)('get-all-blogs')];
