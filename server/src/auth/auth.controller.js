...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.refresh = function (refreshToken) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.refreshAccessToken(refreshToken)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        };
        AuthController_1.prototype.signUp = function (signup) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.signUp(signup)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        };
        AuthController_1.prototype.login = function (login) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.login(login)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        ...
        AuthController_1.prototype.profile = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.profile(id)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        };
        AuthController_1.prototype.decode = function (accessToken) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.getUserFromToken(accessToken)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        };
        AuthController_1.prototype.getAllUsers = function () {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.getAllUser()];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        ...
        AuthController_1.prototype.deleteUser = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.deleteUser(id)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
        };
        AuthController_1.prototype.editUser = function (id, updateData) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.editUser(id, updateData)];
                        case 1: return [2 /*return*/, _a.sent()];
                    }
                });
            });
    ...
    (function () {
        ...
        _signUp_decorators = [(0, common_1.Post)('sign-up')];
        _login_decorators = [(0, common_1.Post)('login')];
        _profile_decorators = [(0, common_1.Get)('profile/:id')];
        _decode_decorators = [(0, common_1.Post)('decode')];
        _getAllUsers_decorators = [(0, common_1.Get)('get-all-users')];
        _deleteUser_decorators = [(0, common_1.Delete)('delete/:id')];
        _editUser_decorators = [(0, common_1.Put)('edit/:id')];
        ...
        __esDecorate(_classThis, null, _decode_decorators, { kind: "method", name: "decode", static: false, private: false, access: { has: function (obj) { return "decode" in obj; }, get: function (obj) { return obj.decode; } }, metadata: _metadata }, null, _instanceExtraInitializers);
