        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    app.use((0, express_1.json)({ limit: '10mb' })); // Thay '10mb' bằng kích thước bạn cần
                    app.use((0, express_1.urlencoded)({ limit: '10mb', extended: true })); // Thay '10mb' bằng kích thước bạn cần
                    // Cấu hình CORS
                    app.enableCors({
